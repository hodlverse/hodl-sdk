...
export declare const MONEY_ADDRESS: {
    [chainId in ChainId]: string;
};
export declare const FARMING_ADDRESS: {
    [chainId in ChainId]: string;
};
export declare const STAKING_ADDRESS: {
    [chainId in ChainId]: string;
};
export declare const TIME_ADDRESS: {
    [chainId in ChainId]: string;
};
export declare const MIGRATOR_ADDRESS: {
    [chainId in ChainId]: string;
};
export declare const WETH_ADDRESS: {
    [chainId in ChainId]: string;
};
export declare const BUYBACK_ADDRESS: {
    [chainId in ChainId]: string;
};
export declare const RESERVE_ADDRESS: {
    [chainId in ChainId]: string;
};
...
export declare const HODL_SWAPPER_ADDRESS: AddressMap;
export declare const HODL_MULTISWAPPER_ADDRESS: AddressMap;
export declare const HODL_MULTI_EXACT_SWAPPER_ADDRESS: AddressMap;
export declare const PEGGED_ORACLE_ADDRESS = "";
export declare const HODL_TWAP_0_ORACLE_ADDRESS = "";
export declare const HODL_TWAP_1_ORACLE_ADDRESS = "";
export declare const CHAINLINK_ORACLE_ADDRESS = "";
